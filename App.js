...
export default function App(){
  return (
    ...
    <View style = {styles.container}>
          <Box style= {{backgroundColor: "#CA6F1E" , borderWidth: 5, borderColor:'black', flex:1 }}>Box 1</Box>
          <Box style= {{backgroundColor: "#7B7D7D", flex:3 }}>Box 2</Box> 
          <Box style= {{backgroundColor: "#A93226", }}>Box 3</Box>
          <Box style= {{backgroundColor: "#C39BD3"}}>Box 4</Box>
          <Box style= {{backgroundColor: "#FAE5D3"}}>Box 5</Box>
          <Box style= {{backgroundColor: "#0E6251"}}>Box 6</Box>
          <Box style= {{backgroundColor: "#633974"}}>Box 7</Box>
    </View> 
